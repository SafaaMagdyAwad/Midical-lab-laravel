                ...
                <script>
                    for (var i = 1; i <= 4; i++) {
                        ...
                        <div class="carousel-item active">
                         <img src="<?php echo e(asset('../IMAGES/slide${i}.jpg')); ?>" class="d-block w-100 slide" alt="...">
                         </div>
        ...
        <div class="container text-center pt-5">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 py-3 wow animate__shakeY" data-wow-duration="7s" data-wow-delay="5s">
                    <div class="card p-2">
                        <img src="<?php echo e(asset('../IMAGES/'.$doctor['image'])); ?>"  class="rounded-circle doctor" height="100px" width="100px" alt="dr:mohammad magdy">
                        <h2 class="text-primary"><?php echo e($doctor['name']); ?></h2>
                        <P><?php echo e($doctor['experience']); ?></P>
                        
                        <div class="d-flex text-primary  p-1">
                            <i class="fa-brands fa-twitter"></i>
                            <p><?php echo e($doctor['twitter']); ?></p>
                        </div><!-- twitter -->
                        <div class="d-flex text-primary p-1">
                            <i class="fa-brands fa-google"></i>
                            <p><?php echo e($doctor['google']); ?></p>
                        </div><!-- google -->
                    </div><!-- card -->
                </div><!-- col -->         
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
Add Testimonial                                </button>
            ...
            <div class="row wow bounceInUp "  data-wow-duration="6s" >
                <div class="col-md-4 col-sm-8 m-2 ">
                    <img src="<?php echo e(asset('../IMAGES/'.$testimonial['image'])); ?>" class="client rounded-18" alt="">
                    
                </div><!-- col -->
                <div class="col-md-6 col-sm-12 m-2">
                    <i class="fa-solid fa-quote-left text-primary mt-5"></i>
                    <h3 class="my-3"><?php echo e($testimonial['name']); ?></h3>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 mb-5">
                    <div class="card p-1">
                        <img src="<?php echo e(asset('../IMAGES/pinifit1.jpg')); ?>" alt="">
                ...
                <div class="col-md-6 col-sm-12 mb-5">
                    <div class="card p-1">
                        <img src="<?php echo e(asset('../IMAGES/pinifit2.jpg')); ?>"  height="470px" alt="">
                ...
                <div class="col-md-3 col-sm-6 mb-5">
                    <div class="card p-1">
                        <img src="<?php echo e(asset('../IMAGES/pinifit3.jpg')); ?>" alt="">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body p-3">
                    ...
                    <form action="<?php echo e(route('testimonial')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">your name</label>
                            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="name" name="name">
...
</html><?php /**PATH C:\xampp\htdocs\projects\midical_lab10\resources\views/index.blade.php ENDPATH**/ ?>